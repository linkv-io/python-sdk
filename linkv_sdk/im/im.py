...
class IM(object):
    ...
    @staticmethod
    def getTokenByThirdUID(third_uid: str) -> dict:
        ...
        sha1.update(bytes('{}|{}|{}|{}'.format(config().app_id, config().app_key, timestamp, nonce), encoding='utf8'))
...
class LvIM(IM):
    ...
    def getTokenByThirdUID(self, third_uid: str) -> dict:
